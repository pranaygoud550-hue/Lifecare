...
const navItems = [
  { to: '/driver', icon: Truck, label: 'Active jobs', end: true },
];
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      <aside className="md:w-64 border-b md:border-b-0 md:border-r border-border bg-card shrink-0">
        <div className="p-5 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-sm">LifeCare+ Driver</p>
              <p className="text-xs text-muted">Ambulance & transport</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted truncate">
                {user.ambulanceDetails?.vehicleNumber || user.phone}
              </p>
            </div>
          </div>
      ...
      <div className="flex-1 min-w-0">
        <header className="sticky top-0 z-10 border-b border-border bg-card/95 backdrop-blur px-4 py-3 md:px-8 flex items-center gap-2">
          ...
          <p className="text-sm text-muted">Driver console — SOS, pickups & live navigation</p>
        </header>
